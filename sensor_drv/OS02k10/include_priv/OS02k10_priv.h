 ...
 *
 */
#ifndef __OS02k10_PRIV_H__
#define __OS02k10_PRIV_H__
...
typedef struct OS02k10_Context_s
{
    IsiSensorContext_t  IsiCtx;                 /**< common context of ISI and ISI driver layer; @note: MUST BE FIRST IN DRIVER CONTEXT */

    IsiMode_t           SensorMode;
...
static RESULT OS02k10_IsiGetCapsIss(IsiSensorHandle_t handle, IsiCaps_t *pIsiCaps);
...
static RESULT OS02k10_IsiExposureControlIss(IsiSensorHandle_t handle, float NewGain, float NewIntegrationTime, uint8_t *pNumberOfFramesToSkip,
                            float *pSetGain, float *pSetIntegrationTime, float *hdr_ratio);
static RESULT OS02k10_IsiGetGainIss(IsiSensorHandle_t handle, float *pSetGain);
static RESULT OS02k10_IsiGetVSGainIss(IsiSensorHandle_t handle, float *pSetGain);
static RESULT OS02k10_IsiGetGainIncrementIss(IsiSensorHandle_t handle, float *pIncr);
static RESULT OS02k10_IsiSetGainIss(IsiSensorHandle_t handle, float NewGain, float *pSetGain, float *hdr_ratio);
static RESULT OS02k10_IsiSetVSGainIss(IsiSensorHandle_t handle, float NewIntegrationTime,
                          	float NewGain, float *pSetGain,float *hdr_ratio);
static RESULT OS02k10_IsiSetLongGainIss(IsiSensorHandle_t handle, float gain);
static RESULT OS02k10_IsiGetIntegrationTimeIss(IsiSensorHandle_t handle, float *pSetIntegrationTime);
static RESULT OS02k10_IsiGetVSIntegrationTimeIss(IsiSensorHandle_t handle, float *pSetIntegrationTime);
static RESULT OS02k10_IsiGetIntegrationTimeIncrementIss(IsiSensorHandle_t handle, float *pIncr);
static RESULT OS02k10_IsiSetIntegrationTimeIss(IsiSensorHandle_t handle, float NewIntegrationTime, float *pSetIntegrationTime,
                            uint8_t *pNumberOfFramesToSkip, float *hdr_ratio);
static RESULT OS02k10_IsiSetVSIntegrationTimeIss(IsiSensorHandle_t handle, float NewIntegrationTime, float *pSetIntegrationTime,
                            uint8_t *pNumberOfFramesToSkip, float *hdr_ratio);
