...
static RESULT IMX290_IsiSensorSetPowerIss(IsiSensorHandle_t handle, bool_t on)
{
...
static RESULT IMX290_IsiResetSensorIss(IsiSensorHandle_t handle)
{
    RESULT result = RET_SUCCESS;
    int32_t ret = 0;
...
static RESULT IMX290_IsiSensorSetClkIss(IsiSensorHandle_t handle, uint32_t clk)
{
    RESULT result = RET_SUCCESS;
    int32_t ret = 0;
...
static RESULT IMX290_IsiSensorGetClkIss(IsiSensorHandle_t handle, uint32_t *pclk)
{
    RESULT result = RET_SUCCESS;
    int32_t ret = 0;
...
static RESULT IMX290_IsiRegisterReadIss(IsiSensorHandle_t handle, const uint32_t address, uint32_t *p_value)
{
    RESULT result = RET_SUCCESS;
    int32_t ret = 0;
    TRACE(IMX290_INFO, "%s (enter)\n", __func__);
...
static RESULT IMX290_IsiRegisterWriteIss(IsiSensorHandle_t handle, const uint32_t address, const uint32_t value)
{
    RESULT result = RET_SUCCESS;
    int32_t ret = 0;
    TRACE(IMX290_INFO, "%s (enter)\n", __func__);
...
static RESULT IMX290_IsiCreateSensorIss(IsiSensorInstanceConfig_t *pConfig)
{
    RESULT result = RET_SUCCESS;
    ...
    if (pIMX290Ctx->HdrMode == SENSOR_MODE_LINEAR && pIMX290Ctx->Resolution == ISI_RES_TV1080P && pIMX290Ctx->MaxFps == 30) {
...
static RESULT IMX290_IsiInitSensorIss(IsiSensorHandle_t   handle)
{
    RESULT result = RET_SUCCESS;
    int ret = 0;
    IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
...
static RESULT IMX290_IsiReleaseSensorIss(IsiSensorHandle_t   handle)
{
    IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    TRACE(IMX290_INFO, "%s (enter)\n", __func__);
...
static RESULT IMX290_IsiGetCapsIss(IsiSensorHandle_t handle, IsiSensorCaps_t *pIsiSensorCaps)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
...
static RESULT IMX290_AecSetModeParameters(IMX290_Context_t *pIMX290Ctx, const IsiSensorConfig_t *pConfig)
{
    RESULT result = RET_SUCCESS;
...
static RESULT IMX290_IsiSetupSensorIss(IsiSensorHandle_t       handle, const IsiSensorConfig_t *pConfig)
{
    IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
...
static RESULT IMX290_IsiGetSupportResolutionIss(IsiSensorHandle_t   handle, IsiResolutionArry_t *pResolutinArry)
{
    RESULT result = RET_SUCCESS;
...
static RESULT IMX290_IsiChangeSensorResolutionIss(IsiSensorHandle_t handle, uint32_t Resolution,uint8_t *pNumberOfFramesToSkip)
{
    IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
...
static RESULT IMX290_IsiSensorSetStreamingIss(IsiSensorHandle_t handle, bool_t on)
{
    RESULT result = RET_SUCCESS;
    int32_t ret = 0;
    int32_t set_val =1;
    ...
    const HalContext_t *pHalCtx = (HalContext_t *)pIMX290Ctx->IsiCtx.HalHandle;
...
static RESULT IMX290_IsiCheckSensorConnectionIss(IsiSensorHandle_t   handle)
{
    RESULT result = RET_SUCCESS;
    uint32_t sensor_id;
    ...
    HalContext_t *pHalCtx = (HalContext_t *)pIMX290Ctx->IsiCtx.HalHandle;
     ...
     if (pIMX290Ctx->KernelDriverFlag) {
        int ret = ioctl(pHalCtx->sensor_fd, VVSENSORIOC_G_RESERVE_ID, &SensorRevChipID);
        if (ret != 0) {
...
static RESULT IMX290_IsiGetSensorRevisionIss(IsiSensorHandle_t handle, uint32_t *p_value)
{
    RESULT result = RET_SUCCESS;
    uint32_t reg_val = 0;
...
static RESULT IMX290_IsiGetGainLimitsIss(IsiSensorHandle_t handle, float *pMinGain, float *pMaxGain)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    uint32_t RegValue = 0U;
...
static RESULT IMX290_IsiGetIntegrationTimeLimitsIss(IsiSensorHandle_t handle, float *pMinIntegrationTime, float *pMaxIntegrationTime)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    uint32_t RegValue = 0U;
...
RESULT IMX290_IsiGetGainIss(IsiSensorHandle_t handle,float *pSetGain)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    TRACE(IMX290_INFO, "%s: (enter)\n", __func__);
...
RESULT IMX290_IsiGetVSGainIss(IsiSensorHandle_t handle,float *pSetGain)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
...
RESULT IMX290_IsiGetGainIncrementIss(IsiSensorHandle_t handle, float *pIncr)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    TRACE(IMX290_INFO, "%s: (enter)\n", __func__);
...
RESULT IMX290_IsiSetGainIss(IsiSensorHandle_t handle, float NewGain, float *pSetGain, float *hdr_ratio)
{
    ...
    if (pIMX290Ctx->KernelDriverFlag) {
        ...
        int ret = ioctl(pHalCtx->sensor_fd, VVSENSORIOC_S_GAIN, &set_val);
    } else {
...
RESULT IMX290_IsiSetVSGainIss(IsiSensorHandle_t handle, float NewIntegrationTime, float NewGain, float *pSetGain, const float *hdr_ratio)
{
    IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    if (!pIMX290Ctx) {
        TRACE(IMX290_ERROR, "%s: Invalid sensor handle (NULL pointer detected)\n", __func__);
...
RESULT IMX290_IsiGetIntegrationTimeIss(IsiSensorHandle_t handle, float *pSetIntegrationTime)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    TRACE(IMX290_INFO, "%s: (enter)\n", __func__);
...
RESULT IMX290_IsiGetVSIntegrationTimeIss(IsiSensorHandle_t handle, float *pSetIntegrationTime)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    TRACE(IMX290_INFO, "%s: (enter)\n", __func__);
...
RESULT IMX290_IsiGetIntegrationTimeIncrementIss(IsiSensorHandle_t handle, float *pIncr)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    TRACE(IMX290_INFO, "%s: (enter)\n", __func__);
...
RESULT IMX290_IsiSetIntegrationTimeIss(IsiSensorHandle_t handle, float NewIntegrationTime, float *pSetIntegrationTime,
                                        uint8_t *pNumberOfFramesToSkip, float *hdr_ratio)
{
    ...
    if (exp_line != pIMX290Ctx->OldIntegrationTime) {
      if (pIMX290Ctx->KernelDriverFlag) {
          int ret = ioctl(pHalCtx->sensor_fd, VVSENSORIOC_S_EXP, &exp_line);
       } else {
          int32_t set_val = IMX290_VTS_NUM - exp_line -1;
          int ret = IMX290_IsiRegisterWriteIss(handle, 0x3020, (set_val&0x000FF));
...
RESULT IMX290_IsiSetVSIntegrationTimeIss(IsiSensorHandle_t handle, float NewIntegrationTime, float *pSetVSIntegrationTime,
                                        uint8_t *pNumberOfFramesToSkip, const float *hdr_ratio)
{
    ...
    if (exp_line != pIMX290Ctx->OldVsIntegrationTime) {
         if (pIMX290Ctx->KernelDriverFlag) {
            int ret = ioctl(pHalCtx->sensor_fd, VVSENSORIOC_S_VSEXP, &exp_line);
         } else {
...
RESULT IMX290_IsiExposureControlIss(IsiSensorHandle_t handle, float NewGain, float NewIntegrationTime, uint8_t *pNumberOfFramesToSkip,
...
RESULT IMX290_IsiGetCurrentExposureIss(IsiSensorHandle_t handle, float *pSetGain, float *pSetIntegrationTime, float *hdr_ratio)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    uint32_t RegValue = 0U;
...
RESULT IMX290_IsiGetResolutionIss(IsiSensorHandle_t handle, uint32_t *pSetResolution)
{
    IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
...
RESULT IMX290_IsiGetSensorFpsIss(IsiSensorHandle_t handle, uint32_t *pfps)
{
    IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    ...
    if (pIMX290Ctx->KernelDriverFlag) {
        int ret = ioctl(pHalCtx->sensor_fd, VVSENSORIOC_G_FPS, pfps);
    }
...
RESULT IMX290_IsiSetSensorFpsIss(IsiSensorHandle_t handle, uint32_t fps)
{
    IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    int32_t ret = 0;
...
RESULT IMX290_IsiGetAfpsInfoIss(IsiSensorHandle_t handle, uint32_t Resolution, IsiAfpsInfo_t* pAfpsInfo)
{
    const IMX290_Context_t *pIMX290Ctx = (IMX290_Context_t *)handle;
    RESULT result = RET_SUCCESS;
    ...
    pAfpsInfo->AecMinIntTime        = pIMX290Ctx->AecMinIntegrationTime;
